const testimonials = [
  {
    quote:
      "Vitality didn't just help me track my runs; it changed how I view my entire day. The 'Living Greenhouse' aesthetic makes me actually want to check my progress.",
    name: "Sarah Jenkins",
    role: "Wellness Coach",
    color: "primary",
  },
  {
    quote:
      "The statistics are gorgeous. I finally understand the link between my hydration and my focus levels. It's an editorial experience for my personal data.",
    name: "Marcus Thorne",
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          ...
          <p className="text-[#35654d] text-lg mb-12 max-w-md">
            Join over 50,000 people who have redefined their daily flow with
            Vitality.
          </p>
          <div className="flex gap-4 items-center">
            ...
            <div className="font-[Manrope] text-sm text-[#35654d]">
              <p className="font-bold text-[#006a35]">4.9/5 Rating</p>
