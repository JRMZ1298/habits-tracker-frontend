    ...
    translation: {
      ...
      landing: {
        ...
        footer: {
          ...
          about: {
            ...
            workOpportunities: "Oportunidades de trabajo",
      ...
      app: {
        ...
        habits: {
          ...
          streakMessage:
            "Este habito es el que tiene mejor racha actualmente. ¡Mantente enfocado!",
          dayStreak: "Mejor racha actual",
        ...
        metrics: {
          ...
          totalYear: "Total este año",
          futureMonths: "Los meses sin datos aún no han ocurrido",
          title: "Métricas de impacto.",
          subtitle: "Visualizando tu viaje en los últimos 12 meses.",
          ...
          personalBest: "¡Mejor racha historica!",
          lifetimeEffort: "Esfuerzo acumulado",
          habitsRooted: "Hábitos completados",
